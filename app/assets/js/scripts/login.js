...
const crackRememberOption   = document.getElementById('crackRememberOption')
...
crackRememberOption.onchange = function() {
	if(crackRememberOption.checked){
		document.getElementById("lockSVG").style.display = "none";
